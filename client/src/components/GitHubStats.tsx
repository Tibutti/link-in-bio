...
export default function GitHubStats({ profile }: GitHubStatsProps) {
  ...
  // Dodajemy kolor (hex bez #) dla wykresu aktywności - domyślnie różowy pasujący do tematu radical
  const activityColor = '9c0079'; // możemy dostosować kolor do tematu strony
  const activityUrl = `https://ghchart.rshah.org/${activityColor}/${profile.githubUsername}`;
